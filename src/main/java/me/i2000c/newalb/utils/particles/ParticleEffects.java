...
//
//import static com.cryptomorin.xseries.particles.XParticle.PII;
//import static com.cryptomorin.xseries.particles.XParticle.randInt;
...
//     */
//    public static void blackSun(double radius, double radiusRate, double rate, double rateChange, ParticleBuilder pb) {
//        double j = 0;
//        for (double i = 10; i > 0; i -= radiusRate) {
//            j += rateChange;
//            circle(radius + i, rate - j, pb);
//        }
//    }
//    
//    /**
...
//     * @see #sphere(double, double, ParticleBuilder)
//     * @see #circle(double, double, double, double, double, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static void circle(double radius, double rate, ParticleBuilder pb) {
//        circle(radius, radius, 1, rate, 0, pb);
//    }
//    
//    /**
//     * Spawns a circle.
...
//     * @see #illuminati(double, double, ParticleBuilder)
//     * @see #eye(double, double, double, double, ParticleBuilder)
//     */
//    public static void circle(double radius, double radius2, double extension, double rate, double limit, ParticleBuilder pb) {
//        // 180 degrees = PI
...
//
//                pb.withOffset(directionX, pb.getOffsetY(), directionZ);
//            }
//
//            pb.spawn(x, 0, z);
//        }
...
//     * @since 4.0.0
//     */
//    public static void diamond(double radiusRate, double rate, double height, ParticleBuilder pb) {
//        double count = 0;
...
//            for (double x = -count; x < count; x += rate) pb.spawn(x, y, 0);
//        }
//    }
//    
//    /**
...
//     * @see #magicCircles(Plugin, double, double, double, double, ParticleBuilder)
//     * @since 3.0.0
//     */
//    public static BukkitTask circularBeam(Plugin plugin, double maxRadius, double rate, double radiusRate, double extend, ParticleBuilder pb) {
//        return new BukkitRunnable() {
//            final double rateDiv = Math.PI / rate;
//            final double radiusDiv = Math.PI / radiusRate;
//            final Vector dir = pb.getLocation().getDirection().normalize().multiply(extend);
...
//     * @param runnable the shape(s) to pb.
//     * @since 4.0.0
//     */
//    public static void flower(int count, double radius, ParticleBuilder pb, Runnable runnable) {
//        for (double theta = 0; theta < PII; theta += PII / count) {
//            double x = radius * Math.cos(theta);
//            double z = radius * Math.sin(theta);
//
//            pb.getLocation().add(x, 0, z);
//            runnable.run();
//            pb.getLocation().subtract(x, 0, z);
//        }
//    }
//
//    /**
...
//     * @since 4.0.0
//     */
//    public static void filledCircle(double radius, double rate, double radiusRate, ParticleBuilder pb) {
//        double dynamicRate = 0;
//        for (double i = 0.1; i < radius; i += radiusRate) {
//            if (i > radius) i = radius;
//            dynamicRate += rate / (radius / radiusRate);
//            circle(i, dynamicRate, pb);
//        }
//    }
//
//    /**
...
//     * The particles pb are showing the path where the second
...
//                                                   boolean dimension3, int speed, ParticleBuilder pb) {
...
//                int repeat = speed;
//                while (repeat-- != 0) {
//                    if (dimension3) pb.rotate(rotation);
...
//
////                locs.forEach((v, v2) -> {
////                    ParticleBuilder dis = pb.clone();
////                    dis.rotation = v2;
////                    dis.spawn(v.getX(), v.getY(), v.getZ());
////                });
////                locs.put(new Vector(x2, y2, 0), pb.rotation.clone());
//                }
//            }
//        }.runTaskTimerAsynchronously(plugin, 0L, 1L);
//    }
...
//     * @return the animation handler.
//     * @see #circularBeam(Plugin, double, double, double, double, ParticleBuilder)
//     * @since 3.0.0
//     */
//    public static BukkitTask magicCircles(Plugin plugin, double radius, double rate, double radiusRate, double distance, ParticleBuilder pb) {
//        return new BukkitRunnable() {
//            final double radiusDiv = Math.PI / radiusRate;
//            final Vector dir = pb.getLocation().getDirection().normalize().multiply(distance);
...
//     * @since 3.0.0
//     */
//    public static void infinity(double radius, double rate, ParticleBuilder pb) {
...
//            circle(1, rate, pb.cloneWithLocation(x, y, z));
//        }
//    }
//
//    /**
...
//     * @since 1.0.0
//     */
//    public static void cone(double height, double radius, double rate, double circleRate, ParticleBuilder pb) {
...
//            circle(radius, circleRate - i, pb.cloneWithLocation(0, i, 0));
//        }
//    }
//
//    /**
...
//     * @since 2.0.0
//     */
//    public static void ellipse(double start, double end, double rate, double radius, double otherRadius, ParticleBuilder pb) {
...
//     * @since 3.0.0
//     */
//    public static BukkitTask blackhole(Plugin plugin, int points, double radius, double rate, int mode, int time, ParticleBuilder pb) {
//        pb.directional();
//        pb.extra = 0.1;
//
//        return new BukkitRunnable() {
...
//
//                    pb.offset(xDirection, 0, zDirection);
//                    pb.spawn(x, 0, z);
//
...
//     * @since 2.0.0
//     */
//    public static void rainbow(double radius, double rate, double curve, double layers, double compact, ParticleBuilder pb) {
//        int[][] rainbow = {
//                {128, 0, 128}, // Violet
//                {75, 0, 130}, // Indigo
//                {0, 0, 255}, // Blue
...
//            int[] rgb = rainbow[i];
//            pb = ParticleBuilder.colored(pb.getLocation(), rgb[0], rgb[1], rgb[2], 1);
//
...
//     * @since 1.0.0
//     */
//    public static void crescent(double radius, double rate, ParticleBuilder pb) {
//        double rateDiv = Math.PI / rate;
...
//     * @since 2.0.0
//     */
//    public static void waveFunction(double extend, double heightRange, double size, double rate, ParticleBuilder pb) {
...
//     * @since 2.0.0
//     */
//    public static BukkitTask vortex(Plugin plugin, int points, double rate, ParticleBuilder pb) {
//        double rateDiv = Math.PI / rate;
//        pb.directional();
//
//        return new BukkitRunnable() {
...
//     * For an actual cylidner just use {@link #circle(double, double, ParticleBuilder)}
...
//     * @since 1.0.0
//     */
//    public static void cylinder(double height, double radius, double rate, ParticleBuilder pb) {
//        filledCircle(radius, rate, 3, pb);
//        filledCircle(radius, rate, 3, pb.cloneWithLocation(0, height, 0));
//        for (double y = 0; y < height; y += 0.1) {
//            circle(radius, rate, pb.cloneWithLocation(0, y, 0));
//        }
//    }
//
//    /**
...
//     * @param pbs the pb references used to spawn particles in the runnable.
//     * @return the async task handling the movement.
//     * @see #rotateAround(Plugin, long, double, double, double, double, Runnable, ParticleBuilder...)
//     * @see #guard(Plugin, long, double, double, double, double, Runnable, ParticleBuilder...)
//     * @since 1.0.0
//     */
...
//                                                Runnable runnable, ParticleBuilder... pbs) {
//        return new BukkitRunnable() {
//            double rotation = 180;
//
//            @Override
...
//                if (offsetx != 0) ParticleBuilder.rotateAround(vector, ParticleBuilder.Axis.X, x);
//                if (offsety != 0) ParticleBuilder.rotateAround(vector, ParticleBuilder.Axis.Y, y);
//                if (offsetz != 0) ParticleBuilder.rotateAround(vector, ParticleBuilder.Axis.Z, z);
//
//                for (ParticleBuilder pb : pbs) pb.getLocation().add(vector);
//                runnable.run();
//                for (ParticleBuilder pb : pbs) pb.getLocation().subtract(vector);
//            }
...
//
//                for (ParticleBuilder pb : pbs) pb.getLocation().add(x, y, z);
//                runnable.run();
//                for (ParticleBuilder pb : pbs) pb.getLocation().subtract(x, y, z);
//
//                if (opposite) {
...
//     * @param rate     the distance between each location. Recommended value is 5.
//     * @param runnable the particles to spawn.
//     * @param pbs the pbs references used to spawn particles in the runnable.
//     * @return the async task handling the movement.
//     * @see #moveRotatingAround(Plugin, long, double, double, double, double, Runnable, ParticleBuilder...)
//     * @see #guard(Plugin, long, double, double, double, double, Runnable, ParticleBuilder...)
//     * @since 1.0.0
//     */
...
//                for (ParticleBuilder pb : pbs) pb.rotate(vector);
//                runnable.run();
//            }
//        }.runTaskTimerAsynchronously(plugin, 0L, update);
//    }
...
//     * This will move the particle around in an area randomly.
//     * The position of the shape will be randomized positively and negatively by the offset parameters on each axis.
//     * Note that the ParticleBuilders used in runnable and pbs options must be from the same reference.
//     * <p>
//     * <b>Example</b>
//     * <pre>
//     *     ParticleBuilders pb = new ParticleBuilder(...);
//     *     {@code WRONG: moveAround(plugin, 1, 5, 1.5, 1.5, 1.5, () -> circle(1, 10, new ParticleBuilder(...)), pb);}
//     *     {@code CORRECT: moveAround(plugin, 1, 5, 1.5, 1.5, 1.5, () -> circle(1, 10, pb), pb);}
//     * </pre>
//     *
//     * @param plugin   the schedule handler.
//     * @param update   the timer period in ticks.
...
//
//                Vector vector = new Vector(offsetx * Math.PI, offsety * Math.PI, offsetz * Math.PI);
//                ParticleBuilder.rotateAround(vector, x, y, z);
//
//                for (ParticleBuilder pb : pbs) {
//                    pb.setRotation(new Vector(x, y, z));
//                    pb.getLocation().add(vector);
//                }
//                runnable.run();
//                for (ParticleBuilder pb : pbs) pb.getLocation().subtract(vector);
//            }
...
//
//                    pb.offset(directionX, directionY, directionZ);
//                }
//
//                pb.spawn(x, y1, z);
//            }
...
//     * @since 1.0.0
//     */
//    public static void spikeSphere(double radius, double rate, int chance, double minRandomDistance, double maxRandomDistance, ParticleBuilder pb) {
//        double rateDiv = Math.PI / rate;
//
...
//                    Location start = pb.cloneLocation(x, y, z);
...
//                    Vector endVect = start.clone().subtract(pb.getLocation()).toVector().multiply(random(minRandomDistance, maxRandomDistance));
//                    Location end = start.clone().add(endVect);
//                    line(start, end, 0.1, pb);
//                }
//            }
//        }
//    }
...
//     * @since 1.0.0
//     */
//    public static void ring(double rate, double radius, double tubeRadius, ParticleBuilder pb) {
//        double rateDiv = Math.PI / rate;
...
//                                    double offsetx, double offsety, double offsetz, ParticleBuilder pb) {
//        return new BukkitRunnable() {
//            int count = amount;
//
//            @Override
...
//     * @since 1.0.0
//     */
//    public static void heart(double cut, double cutAngle, double depth, double compressHeight, double rate, ParticleBuilder pb) {
...
//     * @see #atom(int, double, double, ParticleBuilder, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static BukkitTask atomic(Plugin plugin, int orbits, double radius, double rate, ParticleBuilder orbit) {
//        return new BukkitRunnable() {
//            final double rateDiv = Math.PI / rate;
...
//     * @see #dnaReplication(Plugin, double, double, int, double, int, int, ParticleBuilder)
//     * @since 3.0.0
//     */
//    public static BukkitTask helix(Plugin plugin, int strings, double radius, double rate, double extension, int height, int speed,
//                                   boolean fadeUp, boolean fadeDown, ParticleBuilder pb) {
//        return new BukkitRunnable() {
...
//     *
//     * @param start      the starting point of the new branch. For the first call it's the same location as the pbs location.
...
//                                 double branch, double branchRate, ParticleBuilder pb) {
...
//                    branch * branchRate, branchRate, pb);
...
//     * @param pb             pb for strings.
//     * @param hydrogenBondDisplay pb for hydrogen bonds.
//     * @see #helix(Plugin, int, double, double, double, int, int, boolean, boolean, ParticleBuilder)
//     * @see #dnaReplication(Plugin, double, double, int, double, int, int, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static void dna(double radius, double rate, double extension, int height, int hydrogenBondDist, ParticleBuilder pb, ParticleBuilder hydrogenBondDisplay) {
...
//            Location nucleotide1 = pb.getLocation().clone().add(x, y, z);
//            pb.spawn(x, y, z);
//            Location nucleotide2 = pb.getLocation().clone().subtract(x, -y, z);
//            pb.spawn(-x, y, -z);
//
...
//     * @see #dna(double, double, double, int, int, ParticleBuilder, ParticleBuilder)
//     * @since 3.0.0
//     */
//    public static BukkitTask dnaReplication(Plugin plugin, double radius, double rate, int speed, double extension,
//                                            int height, int hydrogenBondDist, ParticleBuilder pb) {
//        // We'll use the common nucleotide colors.
//        ParticleBuilder adenine = ParticleBuilder.colored(null, java.awt.Color.BLUE, 1); // Blue
//        ParticleBuilder thymine = ParticleBuilder.colored(null, java.awt.Color.YELLOW, 1); // Yellow
//        ParticleBuilder guanine = ParticleBuilder.colored(null, java.awt.Color.GREEN, 1); // Green
//        ParticleBuilder cytosine = ParticleBuilder.colored(null, java.awt.Color.RED, 1); // Red
//
//        return new BukkitRunnable() {
//            double y = 0;
//            int nucleotideDist = 0;
...
//                    Location nucleotide1 = pb.getLocation().clone().add(x, y, z);
//                    //pb.spawn(x, y, z);
//                    circle(0.1, 10, pb.cloneWithLocation(x, y, z));
//                    Location nucleotide2 = pb.getLocation().clone().subtract(x, -y, z);
//                    circle(0.1, 10, pb.cloneWithLocation(-x, y, -z));
//                    //pb.spawn(-x, y, -z);
//
...
//     * @see #line(Location, Location, double, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static void drawLine(Player player, double length, double rate, ParticleBuilder pb) {
//        Location eye = player.getEyeLocation();
//        line(eye, eye.clone().add(eye.getDirection().multiply(length)), rate, pb);
//    }
//
//    /**
...
//     * @since 1.0.0
//     */
//    public static BukkitTask cloud(Plugin plugin, ParticleBuilder cloud, ParticleBuilder rain) {
//        return new BukkitRunnable() {
//            @Override
//            public void run() {
//                cloud.spawn();
...
//     * @param rate  the rate of points of the line.
//     * @see #drawLine(Player, double, double, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static void line(Location start, Location end, double rate, ParticleBuilder pb) {
//        rate = Math.abs(rate);
...
//        z /= length;
//
//        ParticleBuilder clone = pb.clone();
...
//     * Spawns a rectangle.
//     *
//     * @param start the starting point of the rectangle which is equals to the pb location.
//     * @param end   the ending point of the rectangle.
//     * @param rate  the rate of the rectangle points.
//     * @see #cube(Location, Location, double, ParticleBuilder)
//     * @see #cage(Location, Location, double, double, ParticleBuilder)
//     * @since 3.0.0
//     */
//    public static void rectangle(Location start, Location end, double rate, ParticleBuilder pb) {
//        pb.withLocation(start);
...
//     * @see #rectangle(Location, Location, double, ParticleBuilder)
//     * @see #cylinder(double, double, double, ParticleBuilder)
//     * @since 3.0.0
//     */
//    public static void cage(Location start, Location end, double rate, double barRate, ParticleBuilder pb) {
//        double maxX = Math.max(start.getX(), end.getX());
//        double minX = Math.min(start.getX(), end.getX());
//
...
//                Location barStart = pb.spawn(x - minX, 0, z - minZ);
//                Location barEnd = pb.spawn(x - minX, 3, z - minZ);
//
//                if ((x == minX || x + rate > maxX) || (z == minZ || z + rate > maxZ)) {
//                    barChance++;
//                    if (barChance >= barRate) {
//                        barChance = 0;
//                        line(barStart, barEnd, rate, pb);
//                    }
//                }
//            }
//        }
...
//     *     filledCube(start, end, 0.3, new ParticleBuilder(Particle.FLAME, null, 1));
//     * </pre>
//     *
...
//     * @see #cube(Location, Location, double, ParticleBuilder)
//     * @see #structuredCube(Location, Location, double, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static void filledCube(Location start, Location end, double rate, ParticleBuilder pb) {
//        pb.withLocation(start);
//        double maxX = Math.max(start.getX(), end.getX());
//        double minX = Math.min(start.getX(), end.getX());
//
...
//     * @param end   the ending point of the cube.
//     * @param rate  the rate of cube points.
//     * @see #filledCube(Location, Location, double, ParticleBuilder)
//     * @see #structuredCube(Location, Location, double, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static void cube(Location start, Location end, double rate, ParticleBuilder pb) {
//        pb.withLocation(start);
//        double maxX = Math.max(start.getX(), end.getX());
//        double minX = Math.min(start.getX(), end.getX());
//
...
//     * @since 1.0.0
//     */
//    public static void structuredCube(Location start, Location end, double rate, ParticleBuilder pb) {
//        pb.withLocation(start);
//        double maxX = Math.max(start.getX(), end.getX());
//        double minX = Math.min(start.getX(), end.getX());
//
...
//                    if (components >= 2) pb.spawn(x - minX, y - minY, z - minZ);
//                }
//            }
//        }
//    }
...
//     * @see #structuredCube(Location, Location, double, ParticleBuilder)
//     * @see #tesseract(Plugin, double, double, double, long, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static void hypercube(Location startOrigin, Location endOrigin, double rate, double sizeRate, int cubes, ParticleBuilder pb) {
...
//     * @see #hypercube(Location, Location, double, double, int, ParticleBuilder)
//     * @since 4.0.0
//     */
//    public static BukkitTask tesseract(Plugin plugin, double size, double rate, double speed, long ticks, ParticleBuilder pb) {
...
//                    // cube by using the pb.rotate method in one of the axis.
...
//
//                    pb.spawn(projected[0], projected[1], projected[2]);
//                }
//
...
//                    Location start = pb.cloneLocation(pointA[0], pointA[1], pointA[2]);
//                    Location end = pb.cloneLocation(pointB[0], pointB[1], pointB[2]);
//                    line(start, end, rate, pb);
//                }
//
...
//     * @since 4.0.0
//     */
//    public static void mandelbrot(double size, double zoom, double rate, double x0, double y0, int color, ParticleBuilder pb) {
...
//     * @param pb     The particle should be {@link Particle#REDSTONE}
//     * @see #mandelbrot(double, double, double, double, double, int, ParticleBuilder)
//     * @since 4.0.0
//     */
//    public static void julia(double size, double zoom, int colorScheme, double moveX, double moveY, ParticleBuilder pb) {
//        double cx = -0.7;
//        double cy = 0.27015;
//
...
//     * @see #spikeSphere(double, double, int, double, double, ParticleBuilder)
//     * @since 3.0.0
//     */
//    public static void star(Plugin plugin, int points, int spikes, double rate, double spikeLength, double coreRadius,
//                            double neuron, boolean prototype, int speed, ParticleBuilder pb) {
...
//                        ParticleBuilder.rotateAround(vector, ParticleBuilder.Axis.X, spikeAngle);
//                        for (int j = 0; j < points; j++) {
//                            // Rotate the spikes to copy them with equal angles.
//                            ParticleBuilder.rotateAround(vector, ParticleBuilder.Axis.Y, pointsRate);
//                            pb.spawn(vector);
//                        }
//
//                        if (theta >= PII) cancel();
...
//     * @since 4.0.0
//     */
//    public static void eye(double radius, double radius2, double rate, double extension, ParticleBuilder pb) {
//        double rateDiv = Math.PI / rate;
...
//     * @since 4.0.0
//     */
//    public static void illuminati(double size, double extension, ParticleBuilder pb) {
//        polygon(3, 1, size, 1 / (size * 30), 0, pb);
//        // It'd be really hard to automatically adjust the extension based on the size.
//        eye(size / 4, size / 4, 30, extension, pb.cloneWithLocation(0.3, 0, size / 1.8).rotate(Math.PI / 2, Math.PI / 2, 0));
//        circle(size / 5, size * 5, pb.cloneWithLocation(0.3, 0, 0));
//    }
//
//
//    /**
...
//     * @since 1.0.0
//     */
//    public static void polygon(int points, int connection, double size, double rate, double extend, ParticleBuilder pb) {
...
//                pb.spawn(x + (deltaX * pos), 0, z + (deltaZ * pos));
//            }
//        }
//    }
//
...
//     *
//     * @see #polygon(int, int, double, double, double, ParticleBuilder)
//     * @see #circle(double, double, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static void neopaganPentagram(double size, double rate, double extend, ParticleBuilder star, ParticleBuilder circle) {
...
//     * @see #atomic(Plugin, int, double, double, ParticleBuilder)
//     * @since 1.0.0
//     */
//    public static void atom(int orbits, double radius, double rate, ParticleBuilder orbit, ParticleBuilder nucleus) {
...
//     * @since 1.0.0
//     */
//    public static void meguminExplosion(Plugin plugin, double size, ParticleBuilder pb) {
//        polygon(10, 4, size, 0.02, 0.3, pb);
//        polygon(10, 3, size / (size - 1), 0.5, 0, pb);
//        circle(size, 40, pb);
//        spread(plugin, 30, 2, pb.getLocation(), pb.getLocation().clone().add(0, 10, 0), 5, 5, 5, pb);
//    }
//
//    /**
...
//     * @since 1.0.0
//     */
//    public static BukkitTask explosionWave(Plugin plugin, double rate, ParticleBuilder pb, ParticleBuilder secDisplay) {
//        return new BukkitRunnable() {
...
//     * @param location the dynamic location to pb the image at.
//     * @param repeat   amount of times to repeat pbing the image.
//     * @param period   the perioud between each repeats.
//     * @param quality  the quality of the image is exactly the number of particles pb for each pixel. Recommended value is 1
...
//     * @return the async bukkit task pbing the image.
//     * @since 1.0.0
//     */
//    public static BukkitTask pbRenderedImage(Plugin plugin, Map<double[], Color> render, Callable<Location> location,
...
//            public void run() {
//                try {
//                    pbRenderedImage(render, location.call(), quality, speed, size);
//                } catch (Exception e) {
//                    e.printStackTrace();
//                }
//                if (times-- < 1) cancel();
...
//     *
//     * @param render   the rendered image map.
//     * @param location the dynamic location to pb the image at. The {@link Location#getYaw()} determines the image's rotation.
//     * @param quality  the quality of the image is exactly the number of particles pb for each pixel. Recommended value is 1
//     * @param speed    the speed is exactly the same value as the speed of particles. Recommended amount is 0
//     * @param size     the size of the particle. Recommended amount is 0.8
//     * @since 1.0.0
...
//    public static void pbRenderedImage(Map<double[], Color> render, Location location, int quality, int speed, float size) {
...
//
//    /**
//     * Converts a string to an image which can be used to pb as a particle.
//     *
