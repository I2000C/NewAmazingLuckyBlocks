...
public abstract class PaginatedEditorMenu<T, E> extends EditorMenu<T> implements Pageable<E> {
    
    @Delegate
    private final Paginator<E> paginator;
    
    public PaginatedEditorMenu(String menuTitle, MenuSize menuSize, boolean trackLastMenu, 
    ...
    public PaginatedEditorMenu(String menuTitle, MenuSize menuSize, boolean trackLastMenu, MenuSize paginatedMenuSize) {
