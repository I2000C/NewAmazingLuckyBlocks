...
@Getter
@Setter
public class CommandReward extends Reward<CommandReward> {
    ...
    @Override
    public EditorMenu<CommandReward> getEditor() {
        return new CommandMenu();
    }
    
    @Override
    public CommandReward clone() {
        return (CommandReward) super.clone();
    }
}
